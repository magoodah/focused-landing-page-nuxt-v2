<template>
  <div class="min-h-screen bg-white text-gray-800">
    <!-- Direct navigation in the layout -->
    <nav class="bg-white py-4 px-6 shadow-sm">
      <div class="max-w-7xl mx-auto flex justify-between items-center">
        <div class="flex items-center">
          <NuxtLink to="/" class="font-bold text-2xl text-indigo-600">Focused</NuxtLink>
        ...
        <div class="flex items-center space-x-4">
          <NuxtLink to="/#login" class="text-indigo-600 hover:text-indigo-800 font-medium hidden md:inline-block">
            Log in
          </NuxtLink>
          <NuxtLink to="/#signup" class="btn-primary hidden md:inline-block">
            Sign up
          </NuxtLink>
